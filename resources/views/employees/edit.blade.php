...
@section('sub-title', 'Update Employee')
...
<form action="{{ route('employees.update', $employee->id) }}" method="POST" class="mt-4">
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-10">
            <textarea class="form-control" id="alamat" name="alamat" required>{{ old('alamat', $employee->alamat) }}</textarea>
        </div>
    </div>
    <div class="mb-3 row">
    ...
    <div class="mb-3 row">
        <label for="department_id" class="col-sm-2 col-form-label fs-4">Department</label>
        <div class="col-sm-4">
        ...
        <label for="jabatan_id" class="col-sm-2 col-form-label fs-4">Position</label>
        <div class="col-sm-4">
